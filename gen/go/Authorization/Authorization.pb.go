...
const file_Authorization_Authorization_proto_rawDesc = "" +
	"\n" +
	"!Authorization/Authorization.proto\x12\x04auth\"C\n" +
	...
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponce\x126\n" +
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponceB/Z-TerreDHermes.Authorization.v1;Authorizationv1b\x06proto3"
